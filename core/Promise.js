...
class _Promise {
    ...
    resolveCallback(promise2, onFulfilled, resolve, reject) {
    ...
    rejectCallback(promise2, onRejected, resolve, reject) {
    ...
    then(onFulfilled, onRejected) {
        const promise2 = new _Promise((resolve, reject) => {
            queueMicrotask(() => {
                ...
                const resolveCallback = this.resolveCallback(promise2, onFulfilled, resolve, reject);
                const rejectCallback = this.rejectCallback(promise2, onRejected, resolve, reject);
